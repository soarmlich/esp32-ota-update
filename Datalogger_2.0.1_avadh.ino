...
#define RELAY_PIN 34 //  Relay pin mode 

// ---------------- Modbus Settings -------------------
byte SLAVE_ID = 001;
const byte FUNC_READ = 0x03;
const byte START_HIGH = 0x20;
const byte START_LOW  = 0x00;
const byte COUNT_HIGH = 0x00;
const byte COUNT_LOW  = 0x28;  // Read 10 registers
...
void setup() {
  ...
  if(isnan(lastNightTotal))lastNightTotal = 0.0;
  ...
  Serial.print(" Saved Yesterday Total :  ");Serial.println(yesterday_total);
