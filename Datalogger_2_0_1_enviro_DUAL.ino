...
if (readModbus(machine_id2,in_flow, in_total)) {
  ...
  doc["sensor_type"] = "RS485_enviro_dual";
  ...
  if(ch2_status==1){
    ...
    if(ch2_final_value<0)ch2_final_value=0.0;
  ...
  if(ch5_final_value<0)ch5_final_value=0.0;
